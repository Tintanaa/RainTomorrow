...
st.markdown(
    ...
    Для выполнения РГР мною был выбран датасет для классификации Rain in Australia
    ...
    ### Отбор признаков производился после проведения EDA над изначальным датасетом:
